...
public class InventoryGUI implements Listener {
	 ...
	 */
	public InventoryGUI(Plugin plugin, Inventory inventory) throws GuiException {
	 ...
	 * @param inventory The inventory to create a GUI from
	 */
	public InventoryGUI(Inventory inventory) throws GuiException {
		this(RCore.getInstance(), inventory);
	}
//
//	/**
...
//	 */
//	public InventoryGUI(Plugin plugin, int size, String name) throws GuiException {
//		this(plugin, size, Component.text(name));
//	}
//
//	/**
//	 * Creates a new GUI, instantiating a new inventory with the given size and name
...
//	 */
//	public InventoryGUI(Plugin plugin, int size, Component title) throws GuiException {
...
//	 * @param name The name of the inventory
//	 */
//	public InventoryGUI(String name) throws GuiException {
//		this(RCore.getInstance(), 54, Component.text(name));
//	}
//
//	/**
//	 * Creates a new GUI, instantiating a new inventory with the given size and name
...
//	 * @param title The name of the inventory
//	 */
//	public InventoryGUI(Component title) throws GuiException {
//		this(RCore.getInstance(), Bukkit.createInventory(null, 54, title));
//	}
	...
	/**
	 * Add a button to the GUI in first free slot
	 *
	 * @param button The button to be added
	 */
	public void addButton(ItemButton button) {
		...
		for (int i = 0; i < getSize(); i++)
			if (inventory.getItem(i) == null || inventory.getItem(i).getType().isAir() || inventory.getItem(i).getType().equals(FILLER.getType())) {
				slot = i;
				break;
			}
		button.setSlot(slot);
