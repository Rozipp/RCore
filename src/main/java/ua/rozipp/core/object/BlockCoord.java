...
public class BlockCoord implements Cloneable {
    ...
    public boolean inMainWorld() {
        return this.world.equals(PluginHelper.getMainWorld());
    }
    ...
    public String toString() {
        return getClass().getSimpleName() + "{" + this.world.getName() + "," + this.x + "," + this.y + "," + this.z + "}";
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof BlockCoord) {
            ...
            if (otherCoord.getWorld() == null)
                return this.getWorld() == null && otherCoord.getX() == x && otherCoord.getY() == y && otherCoord.getZ() == z;
            else
